extends Button
# Skill ID
@export var skill_id: String = "stamina2"
@onready var label: Label = $"../Text for upgrades/Stamina Upgrade 2/Label"
@onready var buy: Button = $"../Text for upgrades/Stamina Upgrade 2/Buy"
@onready var cancel: Button = $"../Text for upgrades/Stamina Upgrade 2/Cancel"
