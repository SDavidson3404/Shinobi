extends Button
# Skill ID
@export var skill_id: String = "health4"
@onready var label: Label = $"../Text for upgrades/Health Upgrade 4/Label"
@onready var buy: Button = $"../Text for upgrades/Health Upgrade 4/Buy"
@onready var cancel: Button = $"../Text for upgrades/Health Upgrade 4/Cancel"
