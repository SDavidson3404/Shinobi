extends Button
# Skill ID
@export var skill_id: String = "wall_run"
@onready var label: Label = $"../Text for upgrades/Wall Run/Label"
@onready var buy: Button = $"../Text for upgrades/Wall Run/Buy"
@onready var cancel: Button = $"../Text for upgrades/Wall Run/Cancel"
