extends Button
# Skill ID
@export var skill_id: String = "dagger_unlock"
@onready var label: Label = $"../Text for upgrades/Dagger Unlock/Label"
@onready var buy: Button = $"../Text for upgrades/Dagger Unlock/Buy"
@onready var cancel: Button = $"../Text for upgrades/Dagger Unlock/Cancel"
