extends Button
# Skill ID
@export var skill_id: String = "sharp_spear"
@onready var cancel: Button = $"../Text for upgrades/Sharp Spear/Cancel"
@onready var buy: Button = $"../Text for upgrades/Sharp Spear/Buy"
@onready var label: Label = $"../Text for upgrades/Sharp Spear/Label"
