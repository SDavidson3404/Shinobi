extends Button
# Skill ID
@export var skill_id: String = "stamina4"
@onready var mesh: MeshInstance2D = $"../Text for upgrades/MeshInstance2D"
@onready var label: Label = $"../Text for upgrades/Stamina Upgrade 4/Label"
@onready var buy: Button = $"../Text for upgrades/Stamina Upgrade 4/Buy"
@onready var cancel: Button = $"../Text for upgrades/Stamina Upgrade 4/Cancel"
var Menu = false
# ======= READY =======
