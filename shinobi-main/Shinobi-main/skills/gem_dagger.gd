extends Button
# Skill ID
@export var skill_id: String = "gem_dagger"
@onready var buy: Button = $"../Text for upgrades/Gem Dagger/Buy"
@onready var label: Label = $"../Text for upgrades/Gem Dagger/Label"
@onready var cancel: Button = $"../Text for upgrades/Gem Dagger/Cancel"
