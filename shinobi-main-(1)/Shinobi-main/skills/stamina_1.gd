extends Button
# Skill ID
@export var skill_id: String = "stamina1"
@onready var label: Label = $"../Text for upgrades/Stamina Upgrade 1/Label"
@onready var buy: Button = $"../Text for upgrades/Stamina Upgrade 1/Buy"
@onready var cancel: Button = $"../Text for upgrades/Stamina Upgrade 1/Cancel"
