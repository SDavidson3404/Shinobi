extends Button
# Skill ID
@export var skill_id: String = "the_ultima_spear"
@onready var label: Label = $"../Text for upgrades/The Ultima Spear/Label"
@onready var buy: Button = $"../Text for upgrades/The Ultima Spear/Buy"
@onready var cancel: Button = $"../Text for upgrades/The Ultima Spear/Cancel"
