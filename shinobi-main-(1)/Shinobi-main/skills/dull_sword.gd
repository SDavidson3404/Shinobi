extends Button
# Skill ID
@export var skill_id: String = "dull_sword"
@onready var label: Label = $"../Text for upgrades/Dull Sword/Label"
@onready var buy: Button = $"../Text for upgrades/Dull Sword/Buy"
@onready var cancel: Button = $"../Text for upgrades/Dull Sword/Cancel"
