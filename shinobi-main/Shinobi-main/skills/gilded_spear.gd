extends Button
# Skill ID
@export var skill_id: String = "gilded_spear"
@onready var label: Label = $"../Text for upgrades/Gilded Spear/Label"
@onready var buy: Button = $"../Text for upgrades/Gilded Spear/Buy"
@onready var cancel: Button = $"../Text for upgrades/Gilded Spear/Cancel"
