extends Button
# Skill ID
@export var skill_id: String = "sharp_dagger"
@onready var label: Label = $"../Text for upgrades/Sharp Dagger/Label"
@onready var buy: Button = $"../Text for upgrades/Sharp Dagger/Buy"
@onready var cancel: Button = $"../Text for upgrades/Sharp Dagger/Cancel"
