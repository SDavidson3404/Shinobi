extends Button
# Skill ID
@export var skill_id: String = "weapon_throw"
@onready var label: Label = $"../Text for upgrades/Weapon Throw/Label"
@onready var buy: Button = $"../Text for upgrades/Weapon Throw/Buy"
@onready var cancel: Button = $"../Text for upgrades/Weapon Throw/Cancel"
