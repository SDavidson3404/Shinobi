extends Button
# Skill ID
@export var skill_id: String = "buster_dagger"
@onready var cancel: Button = $"../Text for upgrades/Buster Dagger/Cancel"
@onready var buy: Button = $"../Text for upgrades/Buster Dagger/Buy"
@onready var label: Label = $"../Text for upgrades/Buster Dagger/Label"
