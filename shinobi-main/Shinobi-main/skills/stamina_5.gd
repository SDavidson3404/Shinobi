extends Button
# Skill ID
@export var skill_id: String = "stamina5"
@onready var label: Label = $"../Text for upgrades/Stamina Upgrade 5/Label"
@onready var buy: Button = $"../Text for upgrades/Stamina Upgrade 5/Buy"
@onready var cancel: Button = $"../Text for upgrades/Stamina Upgrade 5/Cancel"
