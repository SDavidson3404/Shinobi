...
@onready var label: Label = $"../Text for upgrades/Health Upgrade 2/Label"
@onready var buy: Button = $"../Text for upgrades/Health Upgrade 2/Buy"
@onready var cancel: Button = $"../Text for upgrades/Health Upgrade 2/Cancel"
