extends Button
# Skill ID
@export var skill_id: String = "spear_unlock"
@onready var label: Label = $"../Text for upgrades/Spear Unlock/Label"
@onready var buy: Button = $"../Text for upgrades/Spear Unlock/Buy"
@onready var cancel: Button = $"../Text for upgrades/Spear Unlock/Cancel"
