extends Button
# Skill ID
@export var skill_id: String = "sharp_sword"
@onready var mesh: MeshInstance2D = $"../Text for upgrades/MeshInstance2D"
@onready var buy: Button = $"../Text for upgrades/Sharp Sword/Buy"
@onready var label: Label = $"../Text for upgrades/Sharp Sword/Label"
@onready var cancel: Button = $"../Text for upgrades/Sharp Sword/Cancel"
var Menu = false
# ======= READY =======
