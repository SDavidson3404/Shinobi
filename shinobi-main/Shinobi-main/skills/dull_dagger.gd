extends Button
# Skill ID
@export var skill_id: String = "dull_dagger"
@onready var label: Label = $"../Text for upgrades/Dull Dagger/Label"
@onready var buy: Button = $"../Text for upgrades/Dull Dagger/Buy"
@onready var cancel: Button = $"../Text for upgrades/Dull Dagger/Cancel"
