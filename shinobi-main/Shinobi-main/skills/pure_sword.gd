extends Button
# Skill ID
@export var skill_id: String = "pure_sword"
@onready var mesh: MeshInstance2D = $"../Text for upgrades/MeshInstance2D"
@onready var buy: Button = $"../Text for upgrades/Pure Sword/Buy"
@onready var label: Label = $"../Text for upgrades/Pure Sword/Label"
@onready var cancel: Button = $"../Text for upgrades/Pure Sword/Cancel"
var Menu = false
# ======= READY =======
