extends Button
# Skill ID
@export var skill_id: String = "health1"
@onready var label: Label = $"../Text for upgrades/Health Upgrade 1/Label"
@onready var buy: Button = $"../Text for upgrades/Health Upgrade 1/Buy"
@onready var cancel: Button = $"../Text for upgrades/Health Upgrade 1/Cancel"
