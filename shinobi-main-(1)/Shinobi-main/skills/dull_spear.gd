extends Button
# Skill ID
@export var skill_id: String = "dull_spear"
@onready var label: Label = $"../Text for upgrades/Dull Spear/Label"
@onready var buy: Button = $"../Text for upgrades/Dull Spear/Buy"
@onready var cancel: Button = $"../Text for upgrades/Dull Spear/Cancel"
