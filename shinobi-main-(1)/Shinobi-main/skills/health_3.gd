extends Button
# Skill ID
@export var skill_id: String = "health3"
@onready var label: Label = $"../Text for upgrades/Health Upgrade 3/Label"
@onready var buy: Button = $"../Text for upgrades/Health Upgrade 3/Buy"
@onready var cancel: Button = $"../Text for upgrades/Health Upgrade 3/Cancel"
