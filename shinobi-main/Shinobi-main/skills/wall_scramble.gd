extends Button
# Skill ID
@export var skill_id: String = "wall_scramble"
@onready var label: Label = $"../Text for upgrades/Wall Scramble/Label"
@onready var buy: Button = $"../Text for upgrades/Wall Scramble/Buy"
@onready var cancel: Button = $"../Text for upgrades/Wall Scramble/Cancel"
