...
@onready var label: Label = $"../Text for upgrades/Burst Mode/Label"
@onready var buy: Button = $"../Text for upgrades/Burst Mode/Buy"
@onready var cancel: Button = $"../Text for upgrades/Burst Mode/Cancel"
