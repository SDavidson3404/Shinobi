extends Button
# Skill ID
@export var skill_id: String = "steel_spear"
@onready var label: Label = $"../Text for upgrades/Steel Spear/Label"
@onready var buy: Button = $"../Text for upgrades/Steel Spear/Buy"
@onready var cancel: Button = $"../Text for upgrades/Steel Spear/Cancel"
