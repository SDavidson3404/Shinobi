...
@onready var label: Label = $"../Text for upgrades/Forged Sword/Label"
@onready var cancel: Button = $"../Text for upgrades/Forged Sword/Cancel"
@onready var buy: Button = $"../Text for upgrades/Forged Sword/Buy"
