extends Button
# Skill ID
@export var skill_id: String = "stamina3"
@onready var mesh: MeshInstance2D = $"../Text for upgrades/MeshInstance2D"
@onready var label: Label = $"../Text for upgrades/Stamina Upgrade 3/Label"
@onready var buy: Button = $"../Text for upgrades/Stamina Upgrade 3/Buy"
@onready var cancel: Button = $"../Text for upgrades/Stamina Upgrade 3/Cancel"
var Menu = false
# ======= READY =======
