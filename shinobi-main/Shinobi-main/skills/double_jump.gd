...
@onready var label: Label = $"../Text for upgrades/Double Jump/Label"
@onready var buy: Button = $"../Text for upgrades/Double Jump/Buy"
@onready var cancel: Button = $"../Text for upgrades/Double Jump/Cancel"
