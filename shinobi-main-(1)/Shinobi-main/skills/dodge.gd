extends Button
# Skill ID
@export var skill_id: String = "dodge"
@onready var label: Label = $"../Text for upgrades/Dodge/Label"
@onready var buy: Button = $"../Text for upgrades/Dodge/Buy"
@onready var cancel: Button = $"../Text for upgrades/Dodge/Cancel"
