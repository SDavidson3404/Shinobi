extends Button
# Skill ID
@export var skill_id: String = "health5"
@onready var buy: Button = $"../Text for upgrades/Health Upgrade 5/Buy"
@onready var label: Label = $"../Text for upgrades/Health Upgrade 5/Label"
@onready var cancel: Button = $"../Text for upgrades/Health Upgrade 5/Cancel"
