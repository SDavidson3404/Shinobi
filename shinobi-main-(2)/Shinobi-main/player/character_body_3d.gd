...
@onready var dagger: Node3D = $"Orientation/aspects/Weapon holster/Dagger"

# ========================
# SAVE
# ========================
var scene_to_save := "res//level_1" # Will change to file that is going to save
var level_1 := "res://level_1" # Level 1 path
var level_2 := "res://level_2" # Level 2 path
var level_3 := "res://level_3" # Level 3 path
...
# JUMP
# ==========================
@export var Max_jumps = 0 # Number of jumps can perform
...
const WALL_RUN_GRAVITY := -1.0 # Gravity during wall run
const WALL_ANGLE_THRESHOLD := 0.7 # Angle of raycasts checking for walls
...
func _ready() -> void:
	...
	if SkillManager.check_unlocked("double_jump"): Max_jumps = 1
...
func _physics_process(delta: float) -> void:
	# If player on floor, reset jumps and wall climb
	if is_on_floor():
		Current_jumps = 0
...
func stop_wall_run(): is_wall_running = false
