...
func load_skills():
	skills = {
		...
		"sharp_dagger": {"unlocked": false, "prereq": ["dagger_unlock"]},
		"pure_dagger": {"unlocked": false, "prereq": ["sharp_dagger"]},
		"sharp_spear": {"unlocked": false, "prereq": ["spear_unlock"]},
		"the_ultima_spear": {"unlocked": false, "prereq": ["sharp_spear"]},
		"sharp_sword": {"unlocked": false, "prereq": ["wall_scramble"]},
		"buster_sword": {"unlocked": false, "prereq": ["sharp_sword"]},
	}
...
func can_unlock(id: String) -> bool:
	...
	if player_points < 1: return false
	# For skills needed to unlock, if skill isnt unlocked, return NO
	for pre in skill["prereq"]: if not skills[pre]["unlocked"]: return false
