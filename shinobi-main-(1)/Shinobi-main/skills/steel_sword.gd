extends Button
# Skill ID
@export var skill_id: String = "steel_sword"
@onready var label: Label = $"../Text for upgrades/Steel Sword/Label"
@onready var buy: Button = $"../Text for upgrades/Steel Sword/Buy"
@onready var cancel: Button = $"../Text for upgrades/Steel Sword/Cancel"
